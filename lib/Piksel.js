  ...
  _createClass(Piksel, [{
    ...
    value: function _makePlayerUrl() {
      if (this.options.overrideURL) {
        ...
        return this._buildPlayerOptions(base + '?embed=js&de-callback-method=' + this.options._callbackFnName + '&de-html-default=true&targetId=' + this.options.injectID + '&de-appid=' + this.options._appid, this.options);
      }
    }
  }, {
